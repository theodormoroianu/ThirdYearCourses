...
class Parameters:
    def __init__(self):
        ...
        self.dir_test_examples = os.path.join(self.base_dir, 'exempleTest//simpsons_test_set//') # 'exempleTest/CursVA'   'exempleTest/CMU+MIT'
        self.path_annotations = os.path.join(self.base_dir, 'exempleTest//test_annotations.txt')
